    ...
    <div class="mt-5">
        ...
        <div class="row">
            <div class="col-sm-6 offset-sm-3">
                <form action="/admin/chi-tiet-san-pham-update?id=${sp.id}" method="post" enctype="multipart/form-data">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" min="0" step="1" class="form-control" name="namBaoHanh"
                               value="${sp.namBH}">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Số Lượng Tồn</label>
                        <input type="number" min="0" step="1" class="form-control" name="soLuongTonSanPham"
                               value="${sp.soLuongTon}">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="file" name="assets" size="60">
